...
## Mengaitkannya dengan Windi

Install dulu package yang dibutuhkan:

```bash
pnpm i -D mini-ssg-zen windicss npm-run-all
```

Terus, di `package.json`:
...
```diff
{
  ...
  "main": "index.js",
  "scripts": {
+    "dev:windi": "windicss './dev/pages/**/*.html' './dev/layouts/**/*.html' './dev/components/**/*.html' './dev/imports/**/*.html' -to './dev/static/windi.css' --dev --style",
+    "dev:ssg": "ssg --watch",
+    "dev": "run-p dev:*",
+    "build:windi": "windicss './dev/pages/**/*.html' './dev/layouts/**/*.html' './dev/components/**/*.html' './dev/imports/**/*.html' -mto './dev/static/windi.css' --style",
+    "build:ssg": "ssg",
+    "build": "run-s build:*"
  },
  "keywords": [],
